...
import AangJPG from '../../static/images/aang.jpg'; //import aang image
import ErrorSVG from '../../static/images/error-icon.svg'; //import error icon image
    ...
    render() {
        return (
            <div className="container">
                ...
                {/*welcome statement*/}
                <h1 className="mt-4">Welcome Janelle Leung</h1>
                <div className="progress my-5">
                    <div className="progress-bar active" role="progressbar" aria-valuenow={50} aria-valuemin={0}
                    ...
                    <div className="card-group pt-md-4">
                        <div className="card mx-3">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Aang is the Last Airbender and rides a flying bison named
                                    Appa.</p>
                                <div className="row">
                                    <button type="button" className="btn btn-primary mx-2 w-100">Learn About the
                                        Avatar
                                    </button>
                                </div>
                            </div>
